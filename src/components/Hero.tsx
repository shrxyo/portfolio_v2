...
export default function Hero() {
  return (
    <section
      id="home"
      className="bg-cream min-h-[92dvh] flex items-center"
    >
      <div className="max-w-content mx-auto w-full px-6 md:px-10 py-24">
        <Reveal>
          {/* Eyebrow */}
          ...
          {/* Headline */}
          <h1 className="text-ink font-sans font-medium text-[clamp(2rem,5vw,3.5rem)] leading-[1.12] tracking-[-0.02em] max-w-[820px] mb-6">
            I build and study language models —{' '}
            reasoning, retrieval, and the systems
            {' '}that make them{' '}
            <Accent>useful.</Accent>
          </h1>

          {/* Sub-line */}
          <p className="text-muted text-[17px] leading-relaxed max-w-[520px] mb-10">
